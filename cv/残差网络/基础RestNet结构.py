...
def reside():
    ...
    conv1=tf.layers.conv2d(img_tensor,64,[3,3],[2,2],padding='same')#[50,16,16,64]

    conv2=tf.layers.conv2d(conv1,128,[3,3],[2,2],padding='same')#[50,8,8,128]
    conv3 = tf.layers.conv2d(conv2, 128, [3, 3], [1, 1], padding='same')  # [50,8,8,128]
